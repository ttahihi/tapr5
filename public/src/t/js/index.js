...
function ShowToast() {
  ...
  $(document).ready(function() {
    ...
    $('#Facebook').click(function() {
        OpenUrl('https://www.facebook.com/ttzaliaya');
    });
      // SET URL YOUTUBE
    $('#Youtube').click(function() {
        OpenUrl('https://www.youtube.com/@anhtrinhgaming4411');
    });
    // SET URL DISCORDS
    $('#Discord').click(function() {
        OpenUrl('https://discord.gg/mtPwxDSj');
    });
      // SET URL INSTAGRAM
    $('#Instagram').click(function() {
        OpenUrl('https://www.instagram.com/tazxje._/');
    });
  });
